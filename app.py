...
APP_TITLE = "Exploratory Data Analysis Application"
# APP_ICON = "🔮"
...
DATA_SOURCE_FILE = "Upload from Local Computer"
DATA_SOURCE_URL = "Upload from URL"
DATA_SOURCE_DEMO = "Use Demo Datasets"
DATA_SOURCES = [
    DATA_SOURCE_FILE,
    DATA_SOURCE_URL,
    DATA_SOURCE_DEMO
...
def main():
    ...
    with st.beta_expander("Load Data", True):
        ...
        if dataset_source != DATA_SOURCE_DEMO:
            ...
            with col2:
                sep = st.selectbox('Separator', DATA_CSV_SEPERATORS)
